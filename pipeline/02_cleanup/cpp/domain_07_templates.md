# Definition Cleanup Agent — C++ — Templates (8 terms)
...
This file covers **C++ — Templates** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_07_templates.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_07_templates_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_07_templates.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_07_templates_fix.json` using the Write tool.
