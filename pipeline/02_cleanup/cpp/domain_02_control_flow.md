# Definition Cleanup Agent — C++ — Control Flow (9 terms)
...
This file covers **C++ — Control Flow** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_02_control_flow.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_02_control_flow_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_02_control_flow.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_02_control_flow_fix.json` using the Write tool.
