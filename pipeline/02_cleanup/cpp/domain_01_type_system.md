# Definition Cleanup Agent — C++ — Type System (11 terms)
...
This file covers **C++ — Type System** — **11 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_01_type_system.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_01_type_system_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_01_type_system.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_01_type_system_fix.json` using the Write tool.
