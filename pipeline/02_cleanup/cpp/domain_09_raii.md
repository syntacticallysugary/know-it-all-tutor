# Definition Cleanup Agent — C++ — RAII (11 terms)
...
This file covers **C++ — RAII** — **11 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_09_raii.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_09_raii_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_09_raii.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_09_raii_fix.json` using the Write tool.
