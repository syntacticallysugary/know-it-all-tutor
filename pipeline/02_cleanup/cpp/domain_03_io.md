# Definition Cleanup Agent — C++ — I/O (8 terms)
...
This file covers **C++ — I/O** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_03_io.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_03_io_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_03_io.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/cpp_domains/domain_03_io_fix.json` using the Write tool.
