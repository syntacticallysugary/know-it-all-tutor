# Definition Cleanup Agent — AWS — IaC and DevOps (11 terms)
...
This file covers **AWS — IaC and DevOps** — **11 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_10_iac_devops.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_10_iac_devops_fix.json` |
...
{
  "domain_index": 10,
  "domain_name": "AWS — IaC and DevOps",
  "term_count": 11,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_10_iac_devops.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_10_iac_devops_fix.json` using the Write tool.
