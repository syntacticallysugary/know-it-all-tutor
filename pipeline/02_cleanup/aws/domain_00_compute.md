# Definition Cleanup Agent — AWS — Compute (13 terms)
...
This file covers **AWS — Compute** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_00_compute.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_00_compute_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_00_compute.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_00_compute_fix.json` using the Write tool.
