# Definition Cleanup Agent — AWS — AI Services (10 terms)
...
This file covers **AWS — AI Services** — **10 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_06_ai_services.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_06_ai_services_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_06_ai_services.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_06_ai_services_fix.json` using the Write tool.
