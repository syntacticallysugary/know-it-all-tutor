# Definition Cleanup Agent — AWS — Cost Management (10 terms)
...
This file covers **AWS — Cost Management** — **10 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_08_cost_mgmt.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_08_cost_mgmt_fix.json` |
...
{
  "domain_index": 8,
  "domain_name": "AWS — Cost Management",
  "term_count": 10,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_08_cost_mgmt.json` using the Read tool.

2. **Work through all 10 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_08_cost_mgmt_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 10.
