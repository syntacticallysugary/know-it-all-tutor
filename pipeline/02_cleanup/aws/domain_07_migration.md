# Definition Cleanup Agent — AWS — Migration and Transfer (8 terms)
...
This file covers **AWS — Migration and Transfer** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_07_migration.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_07_migration_fix.json` |
...
{
  "domain_index": 7,
  "domain_name": "AWS — Migration and Transfer",
  "term_count": 8,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_07_migration.json` using the Read tool.

2. **Work through all 8 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_07_migration_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 8.
