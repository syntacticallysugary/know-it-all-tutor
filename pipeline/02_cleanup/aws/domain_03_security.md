# Definition Cleanup Agent — AWS — Security (13 terms)
...
This file covers **AWS — Security** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_03_security.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_03_security_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_03_security.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_03_security_fix.json` using the Write tool.
