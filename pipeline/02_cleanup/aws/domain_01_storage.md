# Definition Cleanup Agent — AWS — Storage (12 terms)
...
This file covers **AWS — Storage** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_01_storage.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_01_storage_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_01_storage.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_01_storage_fix.json` using the Write tool.
