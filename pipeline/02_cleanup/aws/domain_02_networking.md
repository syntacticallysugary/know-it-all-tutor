# Definition Cleanup Agent — AWS — Networking (13 terms)
...
This file covers **AWS — Networking** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_02_networking.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_02_networking_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_02_networking.json` using the Read tool.

2. **Work through all 13 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/aws_domains/domain_02_networking_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 13.
