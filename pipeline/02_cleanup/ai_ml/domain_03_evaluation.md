# Definition Cleanup Agent — AI/ML — Evaluation (14 terms)
...
This file covers **AI/ML — Evaluation** — **14 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_03_evaluation.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_03_evaluation_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_03_evaluation.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_03_evaluation_fix.json` using the Write tool.
