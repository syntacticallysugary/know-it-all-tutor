# Definition Cleanup Agent — AI/ML — Data Preparation (12 terms)
...
This file covers **AI/ML — Data Preparation** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_04_data_prep.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_04_data_prep_fix.json` |
...
{
  "domain_index": 4,
  "domain_name": "AI/ML — Data Preparation",
  "term_count": 12,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_04_data_prep.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_04_data_prep_fix.json` using the Write tool.
