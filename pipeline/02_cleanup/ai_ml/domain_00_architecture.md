# Definition Cleanup Agent — AI/ML — Architecture (14 terms)
...
This file covers **AI/ML — Architecture** — **14 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_00_architecture.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_00_architecture_fix.json` |
...
{
  "domain_index": 0,
  "domain_name": "AI/ML — Architecture",
  "term_count": 14,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_00_architecture.json` using the Read tool.

2. **Work through all 14 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_00_architecture_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 14.
