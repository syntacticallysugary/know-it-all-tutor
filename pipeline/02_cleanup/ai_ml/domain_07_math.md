# Definition Cleanup Agent — AI/ML — Math Foundations (13 terms)
...
This file covers **AI/ML — Math Foundations** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_07_math.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_07_math_fix.json` |
...
{
  "domain_index": 7,
  "domain_name": "AI/ML — Math Foundations",
  "term_count": 13,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_07_math.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_07_math_fix.json` using the Write tool.
