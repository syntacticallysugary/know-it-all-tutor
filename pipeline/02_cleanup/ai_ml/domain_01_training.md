# Definition Cleanup Agent — AI/ML — Training (15 terms)
...
This file covers **AI/ML — Training** — **15 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_01_training.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_01_training_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_01_training.json` using the Read tool.

2. **Work through all 15 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_01_training_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 15.
