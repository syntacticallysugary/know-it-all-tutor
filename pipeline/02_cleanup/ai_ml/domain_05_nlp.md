# Definition Cleanup Agent — AI/ML — NLP (11 terms)
...
This file covers **AI/ML — NLP** — **11 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_05_nlp.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_05_nlp_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_05_nlp.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_05_nlp_fix.json` using the Write tool.
