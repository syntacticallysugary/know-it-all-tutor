# Definition Cleanup Agent — AI/ML — MLOps (12 terms)
...
This file covers **AI/ML — MLOps** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_06_mlops.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_06_mlops_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_06_mlops.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_06_mlops_fix.json` using the Write tool.
