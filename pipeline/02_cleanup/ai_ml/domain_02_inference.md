# Definition Cleanup Agent — AI/ML — Inference (13 terms)
...
This file covers **AI/ML — Inference** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_02_inference.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_02_inference_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_02_inference.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/ai_ml_domains/domain_02_inference_fix.json` using the Write tool.
