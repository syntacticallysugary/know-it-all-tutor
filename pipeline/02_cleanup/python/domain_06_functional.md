# Definition Cleanup Agent — Python — Functional (9 terms)
...
This file covers **Python — Functional** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_06_functional.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_06_functional_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_06_functional.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_06_functional_fix.json` using the Write tool.
