# Definition Cleanup Agent — Python — String Operations (9 terms)
...
This file covers **Python — String Operations** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_07_string_ops.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_07_string_ops_fix.json` |
...
{
  "domain_index": 7,
  "domain_name": "Python — String Operations",
  "term_count": 9,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_07_string_ops.json` using the Read tool.

2. **Work through all 9 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_07_string_ops_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 9.
