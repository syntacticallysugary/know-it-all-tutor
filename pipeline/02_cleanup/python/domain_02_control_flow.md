# Definition Cleanup Agent — Python — Control Flow (12 terms)
...
This file covers **Python — Control Flow** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_02_control_flow.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_02_control_flow_fix.json` |
...
{
  "domain_index": 2,
  "domain_name": "Python — Control Flow",
  "term_count": 12,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_02_control_flow.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_02_control_flow_fix.json` using the Write tool.
