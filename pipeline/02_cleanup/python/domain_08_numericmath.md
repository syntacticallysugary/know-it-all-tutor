# Definition Cleanup Agent — Python — Numeric/Math (7 terms)
...
This file covers **Python — Numeric/Math** — **7 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_08_numericmath.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_08_numericmath_fix.json` |
...
{
  "domain_index": 8,
  "domain_name": "Python — Numeric/Math",
  "term_count": 7,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_08_numericmath.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_08_numericmath_fix.json` using the Write tool.
