# Definition Cleanup Agent — Python — Memory (6 terms)
...
This file covers **Python — Memory** — **6 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_09_memory.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_09_memory_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_09_memory.json` using the Read tool.

2. **Work through all 6 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_09_memory_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 6.
