# Definition Cleanup Agent — Python — Type System (12 terms)
...
This file covers **Python — Type System** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_01_type_system.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_01_type_system_fix.json` |
...
{
  "domain_index": 1,
  "domain_name": "Python — Type System",
  "term_count": 12,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_01_type_system.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_01_type_system_fix.json` using the Write tool.
