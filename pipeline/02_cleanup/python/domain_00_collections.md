# Definition Cleanup Agent — Python — Collections (14 terms)
...
This file covers **Python — Collections** — **14 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_00_collections.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_00_collections_fix.json` |
...
{
  "domain_index": 0,
  "domain_name": "Python — Collections",
  "term_count": 14,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_00_collections.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_00_collections_fix.json` using the Write tool.
