# Definition Cleanup Agent — Python — Iteration (7 terms)
...
This file covers **Python — Iteration** — **7 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_10_iteration.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_10_iteration_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_10_iteration.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_10_iteration_fix.json` using the Write tool.
