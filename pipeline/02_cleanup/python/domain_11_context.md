# Definition Cleanup Agent — Python — Context Managers (5 terms)
...
This file covers **Python — Context Managers** — **5 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_11_context.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_11_context_fix.json` |
...
{
  "domain_index": 11,
  "domain_name": "Python — Context Managers",
  "term_count": 5,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_11_context.json` using the Read tool.

2. **Work through all 5 terms** in order. For each term:
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_11_context_fix.json` using the Write tool.
...
7. **Report**: state how many terms you inspected, how many definitions you
   changed, and how many you left unchanged. The total must equal 5.
