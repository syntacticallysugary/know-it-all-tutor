# Definition Cleanup Agent — Python — Introspection (7 terms)
...
This file covers **Python — Introspection** — **7 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_05_introspection.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_05_introspection_fix.json` |
...
{
  "domain_index": 5,
  "domain_name": "Python — Introspection",
  "term_count": 7,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_05_introspection.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/python_domains/domain_05_introspection_fix.json` using the Write tool.
