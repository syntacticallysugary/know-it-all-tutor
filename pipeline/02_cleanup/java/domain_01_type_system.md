# Definition Cleanup Agent — Java — Type System (12 terms)
...
This file covers **Java — Type System** — **12 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_01_type_system.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_01_type_system_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_01_type_system.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_01_type_system_fix.json` using the Write tool.
