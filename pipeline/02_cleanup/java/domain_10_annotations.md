# Definition Cleanup Agent — Java — Annotations (9 terms)
...
This file covers **Java — Annotations** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_10_annotations.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_10_annotations_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_10_annotations.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_10_annotations_fix.json` using the Write tool.
