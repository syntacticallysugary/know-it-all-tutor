# Definition Cleanup Agent — Java — Memory (8 terms)
...
This file covers **Java — Memory** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_07_memory.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_07_memory_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_07_memory.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_07_memory_fix.json` using the Write tool.
