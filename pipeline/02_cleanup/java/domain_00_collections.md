# Definition Cleanup Agent — Java — Collections (13 terms)
...
This file covers **Java — Collections** — **13 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_00_collections.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_00_collections_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_00_collections.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_00_collections_fix.json` using the Write tool.
