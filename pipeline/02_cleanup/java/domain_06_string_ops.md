# Definition Cleanup Agent — Java — String Operations (8 terms)
...
This file covers **Java — String Operations** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_06_string_ops.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_06_string_ops_fix.json` |
...
{
  "domain_index": 6,
  "domain_name": "Java — String Operations",
  "term_count": 8,
  "terms": [
    {
      "node_type": "term",
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_06_string_ops.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_06_string_ops_fix.json` using the Write tool.
