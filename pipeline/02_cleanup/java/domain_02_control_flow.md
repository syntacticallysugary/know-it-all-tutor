# Definition Cleanup Agent — Java — Control Flow (8 terms)
...
This file covers **Java — Control Flow** — **8 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_02_control_flow.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_02_control_flow_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_02_control_flow.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_02_control_flow_fix.json` using the Write tool.
