# Definition Cleanup Agent — Java — Concurrency (10 terms)
...
This file covers **Java — Concurrency** — **10 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_04_concurrency.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_04_concurrency_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_04_concurrency.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_04_concurrency_fix.json` using the Write tool.
