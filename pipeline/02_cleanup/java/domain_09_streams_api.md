# Definition Cleanup Agent — Java — Streams API (10 terms)
...
This file covers **Java — Streams API** — **10 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_09_streams_api.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_09_streams_api_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_09_streams_api.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_09_streams_api_fix.json` using the Write tool.
