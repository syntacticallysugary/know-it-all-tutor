# Definition Cleanup Agent — Java — Functional (9 terms)
...
This file covers **Java — Functional** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_05_functional.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_05_functional_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_05_functional.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_05_functional_fix.json` using the Write tool.
