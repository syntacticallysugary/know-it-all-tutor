# Definition Cleanup Agent — Java — OOP (9 terms)
...
This file covers **Java — OOP** — **9 terms**.
...
| Role | Path |
|------|------|
| Source (read this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_08_oop.json` |
| Output (write this) | `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_08_oop_fix.json` |
...
1. **Read** `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_08_oop.json` using the Read tool.
...
5. **Write** the complete modified JSON to
   `/home/jimbob/Dev/AWS_Dev/data/java_domains/domain_08_oop_fix.json` using the Write tool.
