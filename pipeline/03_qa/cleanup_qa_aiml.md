# Definition Cleanup QA Agent — AI/ML Domain

## Role

Audit the cleaned AI/ML definition file against the original. For every term,
...
| Role | Path |
|------|------|
| Original | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_upload.json` |
| Fixed | `/home/jimbob/Dev/AWS_Dev/data/ai_ml_upload-fix.json` |
...
1. `/home/jimbob/Dev/AWS_Dev/data/ai_ml_upload-issues.json`
...
- Any acronym found in a parenthetical in the term string
  (e.g., `Generative Adversarial Network (GAN)` → also match `GAN`, `GANs`)
