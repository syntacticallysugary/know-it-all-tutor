# Definition Cleanup QA Agent — TypeScript Domain

## Role

Audit the cleaned TypeScript definition file against the original. For every
...
| Role | Path |
|------|------|
| Original | `/home/jimbob/Dev/AWS_Dev/data/typescript_upload.json` |
| Fixed | `/home/jimbob/Dev/AWS_Dev/data/typescript_upload-fix.json` |
...
1. `/home/jimbob/Dev/AWS_Dev/data/typescript_upload-issues.json`
